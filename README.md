...
Used as the visual layout editor for all FXML files. Each of the application's 22 screens was designed in SceneBuilder, where backdrop images, buttons, labels, text fields, and other interactive elements were positioned and configured before being wired to their corresponding Java controllers.
